...
struct ContentView: View {
    ...
    private var dragAreaThreshold: CGFloat = 95.0
    ...
    private func moveCards() {
        ...
        let honeymoon = honeymoonData[lastCardIndex % honeymoonData.count] //reloop back to first card
            ...
            ZStack{
                ForEach(cardViews) { cardView in
                        cardView
                                ...
                                ZStack {
                                    ...
                                    Image(systemName: "x.circle")
                                        ...
                                        .opacity(self.dragState.translation.width <
                                                 -self.dragAreaThreshold && self.isTopCard(cardView: cardView) ? 1.0 : 0.0)
                            ...
                            .animation(.interpolatingSpring(stiffness:120, damping: 120), value: 0.5)
                            .gesture(LongPressGesture(minimumDuration: 0.01)
                                .sequenced(before: DragGesture())
                                    .updating(self.$dragState, body: { (value, state,
                                        transaction) in
                                        switch value {
                                        case .first(true):
                                            state = .pressing
